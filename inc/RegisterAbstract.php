...
abstract class RegisterAbstract
{
    ...
    public function __construct($post_type, $index_name_base, $algolia_client, $index_settings = null)
    {
        ...
        $this->log->pushHandler(new StreamHandler(__DIR__."/logs/debug.{$this->index_name_base}.log", Logger::DEBUG));
    ...
    private function set_index_name($post_ID)
    {
        ...
        // array filter remove empty cell in imploded arry
        return implode('_', array_filter(array($this->index_name_base, CURRENT_SITE_NETWORK_ID, $this->locale)));
    }
